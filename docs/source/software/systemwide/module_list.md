...
| :---------------- | :--------------  | :-------- |
| Abaqus | A simulation product portfolio for multiphysics, process integration and optimization. | 2024 |
...
| boost  | Boost C++ Libraries, a widely used, free, and open-source collection of C++ libraries that extend the C++ Standard Library's functionality, offering features for data structures, concurrency, networking, and more to aid in C++ application development across various platforms.  | 1.88.0 |
...
| HDF5   | HDF5 is a data model, library, and file format for storing and managing large, complex, and heterogeneous datasets, particularly scientific and numerical data. | 1.14.6, nvhpc-1.14.6 |
...
| SAS   | SAS software is an integrated suite for data management, advanced analytics, business intelligence, and predictive analytics developed by SAS Institute  | 9.4 |
