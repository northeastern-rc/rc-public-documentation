...
:::{important}
1) Request only the resources you need: Overestimating your job's requirements can result in longer queue times. See {ref}`job_eff` to learn about viewing historical job resource utilization.
