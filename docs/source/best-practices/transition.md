...
All of the [modules](https://rc-docs.northeastern.edu/en/explorer-main/software/systemwide/modules.html) on Explorer are new. Some of the versions may have changed from the version you were using on Discovery. Thus, module load commands will need to be updated.
