...
2. Compress directories that are not used frequently or for projects that have been completed. To identify candidate directories for compression you can run our [project storage querying commands](storage-query).
